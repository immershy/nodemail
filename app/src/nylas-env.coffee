...
class NylasEnvConstructor
  ...
  initialize: ->
    ...
    unless @inSpecMode()
      ...
      console.log('@actionBridge = new ActionBridge(ipcRenderer)')
  ...
  setPosition: (x, y) ->
    ...
    console.log('ipcRenderer.send(\'call-window-method\', \'setPosition\', x, y)');
  ...
  fileListCache: ->
    return global.application.fileListCache
  ...
  enhanceEventObject: ->
    console.log('enhanceEventObject')
